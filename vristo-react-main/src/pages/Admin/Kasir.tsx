        ...
        <div>
            ...
            <div className="panel mt-6">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-5 gap-5">
                    ...
                    <h5 className="font-bold text-lg dark:text-white-light">Data Kasir</h5>
                    <button type="button" className="btn btn-primary rounded-full flex items-center" onClick={() => setModal1(true)}><IconPlus className="w-4 h-4 mr-1" /> Tambah Data Kasir</button>
                </div>

                {/* Kolom pencarian */}
                <div className="ltr:ml-auto rtl:mr-auto w-full md:w-auto mb-5">
                                ...
                                <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                                    <Dialog.Panel as="div" className="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                        <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                            <div className="text-lg font-bold">Tambah Data Kasir</div>
                                        ...
                                        <div className="p-5">
                                            <form>
                                                ...
                                                <div>
                                                    <label htmlFor="kasir" className="text-sm inline-block">
                                                        Nama Kasir
                                                    </label>
                                                    <p className="text-sm text-danger inline-block ml-1">*</p>
                                                    <input type="text" placeholder="Masukkan Nama Kasir" className="form-input rounded-xl" required />
                                                </div>
                        ...
                        <div className="fixed inset-0 z-[999] overflow-y-auto bg-[black]/60">
                            <div className="flex min-h-screen items-start justify-center px-4">
                                ...
                                >
                                    <Dialog.Panel as="div" className="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                        <div className="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                                            <div className="text-lg font-bold">Edit Data Kasir</div>
