                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/produk" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Data Produk')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/transaksi" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Transaksi')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/setting-single" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Setting Single Store')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/setting-employee" className="group">
                                            <div className="flex items-center">
                                                <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Setting Employee')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <NavLink to="/dashboard-admin" className="group">
                                    <div className="flex items-center">
                                        <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Dashboard Admin')}</span>
                                    </div>
                                </NavLink>
                            </li>

                            <li className="nav-item">
                                <NavLink to="/kasir" className="group">
                                    <div className="flex items-center">
                                        <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Data Petugas')}</span>
                                    </div>
                                </NavLink>
                            </li>

                            <li className="nav-item">
                                <NavLink to="/cabang" className="group">
                                    <div className="flex items-center">
                                        <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Data Cabang')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="nav-item">
                                <NavLink to="/all-store" className="group">
                                    <div className="flex items-center">
                                        <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('All Store')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="nav-item">
                                <NavLink to="/setting-store" className="group">
                                    <div className="flex items-center">
                                        <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Setting Store')}</span>
                                    </div>
                                </NavLink>
                            </li>

                            <li className="nav-item">
                                <NavLink to="/riwayat" className="group">
                                    <div className="flex items-center">
                                        <IconMenuChat className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Riwayat')}</span>
                                    </div>
                                </NavLink>
                            </li>
